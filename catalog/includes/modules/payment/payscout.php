...
*/
  ...
  class payscout {
    ...
    function before_process() {
	  ...
	  $payscout_api_user_name = MODULE_PAYMENT_PAYSCOUT_CLIENT_USERNAME;
	  $payscout_api_password = MODULE_PAYMENT_PAYSCOUT_CLIENT_PASSWORD;
	  $payscout_api_token = MODULE_PAYMENT_PAYSCOUT_CLIENT_TOKEN;
	  
	  	  
	  if(MODULE_PAYMENT_PAYSCOUT_TRANSACTION_SERVER != 'Live'){
		$payscout_api_user_name = 'victorAPI';
      ...
      $params = array('client_username' => $payscout_api_user_name,
                      ...
                      'client_token' => $payscout_api_token,  
      ...
      if ( MODULE_PAYMENT_PAYSCOUT_TRANSACTION_SERVER == 'Live' ) {
        ...
        $gateway_url = 'https://my.payscout.com/api/process';

      } else {

        $gateway_url = 'https://preprod.payscout.com/api/process';
    ...
    function after_process() {
      ...
      $status[] = 'Response: ' . tep_db_prepare_input($res_text) . ' (' . tep_db_prepare_input($response->status) . ')';
